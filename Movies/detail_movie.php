...
$queryMovie = "SELECT m.name, m.release_date, m.imdb_grade, m.synopsis, m.cover, d.first_name, d.last_name FROM movies m JOIN directors d ON d.id = m.directors_id  WHERE m.id = :movie_id";
...
<body class="backgroundAccueil">
    <div class="cardDetail">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
                <p class="director">Director: <?= $movie['first_name'] . ' ' . $movie['last_name'] ?></p>
